...
using Spriggan.Core.Web.Attributes;

namespace Spriggan.Core.Web.Filters;
...
public class FromRouteBodyAttributeActionFilter : IActionFilter
{
    ...
    private static void SetActionArgumentPropertyValue(PropertyInfo property, object? argument, object? data)
    {
